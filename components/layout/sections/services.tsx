  ...
  return (
    <section id="services" className="container py-24 sm:py-32">
      ...
      <h2 className="text-3xl md:text-4xl text-center font-bold mb-4">
        AI <BrandHighlightedTitle> Solutions </BrandHighlightedTitle> We Offer
      </h2>
      <h3 className="md:w-3/4 mx-auto text-xl text-center text-muted-foreground mb-8">
        We specialize in building cutting-edge AI solutions that help businesses
        innovate and scale. Our expertise spans across various AI domains and
        technologies.
      </h3>
